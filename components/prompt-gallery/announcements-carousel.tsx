...
const ITEMS: AnnouncementItem[] = [
  ...
  { color: 'emerald', icon: <Sparkles className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />, title: 'Redesigned Active Query Panel', badge: 'Improved', body: "The panel showing your current search now clearly shows how many tags you're using, which ones are free, and which count toward each site's limit." },
  { color: 'indigo', icon: <Wrench className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />, title: 'Detailed Random Background Fix', badge: 'Fix', body: 'Fixed the "Detailed Random" background option — it now actually swaps in a full scene instead of just clearing the background.' },
  { color: 'emerald', icon: <Sparkles className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />, title: 'Background Options Optimized', badge: 'Improved', body: 'Improved the Background Options logic so random backgrounds stay consistent between the card preview and what you actually copy.' },
